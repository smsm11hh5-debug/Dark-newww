...
def send_welcome(message):
  ...
  help_text = (
      ...
      "⚡ `/spam <UID>` - لبدء إرسال طلبات الصداقة للايدي\n"
      "🛑 `/stop <UID>` - لإيقاف السبام عن ايدي معين\n"
      "📊 `/status` - لعرض الأيديات النشطة حالياً\n"
      "👥 `/accounts` - لعرض إحصائيات الحسابات (المتصلة وغير المتصلة)\n"
      "🏓 `/ping` - لفحص سرعة استجابة السيرفر\n"
